USE [BookMyShow]
GO
/****** Object:  UserDefinedTableType [dbo].[genreType]    Script Date: 24-07-2023 11:23:25 ******/
CREATE TYPE [dbo].[genreType] AS TABLE(
	[genId] [int] NULL
)
GO
/****** Object:  UserDefinedTableType [dbo].[langType]    Script Date: 24-07-2023 11:23:25 ******/
CREATE TYPE [dbo].[langType] AS TABLE(
	[langId] [int] NULL
)
GO
/****** Object:  Table [dbo].[Customer]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[genre]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[language]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MovieGenre]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MovieLanguage]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[movies]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PaymentOptions]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Place]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProjectionType]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Screen]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Seat]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SeatCategory]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Show]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Student1]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[theater]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Ticket]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TicketSeat]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[theater]  WITH CHECK ADD  CONSTRAINT [FK_theater_PProjectionType] FOREIGN KEY([Projection_Id])
REFERENCES [dbo].[ProjectionType] ([Projection_Id])
GO
ALTER TABLE [dbo].[theater] CHECK CONSTRAINT [FK_theater_PProjectionType]
GO
...
GO
/****** Object:  StoredProcedure [dbo].[genreInsertTable]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[languageInsertTable]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[movieInsert]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
@name VARCHAR(60),
@genreList AS genreType READONLY
--@langList AS langType READONLY
AS
BEGIN
...
DECLARE @Movie_Id INT = scope_identity()
	...
	SELECT @Movie_Id, genId
	FROM @genreList
	
END
GO
/****** Object:  StoredProcedure [dbo].[movieInsertTable]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[placeInsertTable]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[projectioTypeInsertTable]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[theatreInsertTable]    Script Date: 24-07-2023 11:23:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
