USE [BookMyShow]
GO
/****** Object:  UserDefinedTableType [dbo].[genLis]    Script Date: 28-07-2023 18:35:02 ******/
CREATE TYPE [dbo].[genLis] AS TABLE(
	[GENID] [int] NULL
)
GO
/****** Object:  UserDefinedTableType [dbo].[genreType]    Script Date: 28-07-2023 18:35:02 ******/
CREATE TYPE [dbo].[genreType] AS TABLE(
	[genId] [int] NULL
)
GO
/****** Object:  UserDefinedTableType [dbo].[langType]    Script Date: 28-07-2023 18:35:02 ******/
CREATE TYPE [dbo].[langType] AS TABLE(
	[langId] [int] NULL
)
GO
/****** Object:  UserDefinedTableType [dbo].[lanLis]    Script Date: 28-07-2023 18:35:02 ******/
CREATE TYPE [dbo].[lanLis] AS TABLE(
	[LANID] [int] NULL
)
GO
/****** Object:  UserDefinedTableType [dbo].[SCREEN]    Script Date: 28-07-2023 18:35:02 ******/
CREATE TYPE [dbo].[SCREEN] AS TABLE(
	[screen_name] [varchar](60) NULL,
	[projection] [int] NULL
)
GO
/****** Object:  UserDefinedTableType [dbo].[SEAT]    Script Date: 28-07-2023 18:35:02 ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[ticketSeat]    Script Date: 28-07-2023 18:35:02 ******/
CREATE TYPE [dbo].[ticketSeat] AS TABLE(
	[seatID] [int] NULL
)
GO
/****** Object:  Table [dbo].[Customer]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[genre]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[language]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MovieGenre]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MovieLanguage]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[movies]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PaymentOptions]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Place]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProjectionType]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Screen]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Seat]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SeatCategory]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Show]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Student1]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[theater]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Ticket]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TicketSeat]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[bookedTicket]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[genreInsertTable]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetSeatInfoByShowId]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT ST.Seat_Id,
CASE
WHEN TS.Seat_Id IS NOT NULL THEN 'Booked'
ELSE 'Not Booked'
END AS 'Booking Remark'


FROM Show AS SHW
	INNER JOIN Seat AS ST
		ON ST.Screen_Id = SHW.Screen_Id
...
GO
/****** Object:  StoredProcedure [dbo].[GetShowDetails]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[insertPaymentOption]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[languageInsertTable]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[MovieInsert]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[movieInsertTable]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[moviesBylangPlaceGen]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[placeInsertTable]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[projectioTypeInsertTable]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[projectTYpeInsert]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[seatCatInsert]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[theaterInsert]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[TicketBooking]    Script Date: 28-07-2023 18:35:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
